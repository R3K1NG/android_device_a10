...
DEVICE_PACKAGE_OVERLAYS := device/allwinner/lyf1/overlay
...
PRODUCT_COPY_FILES += $(shell test -d device/allwinner/lyf1/prebuilt/lib/modules && \
	find device/allwinner/lyf1/prebuilt/lib/modules -name '*.ko' \
